        ...
        <div className="homepage-main w-[100vw] h-[100vh] bg-black">
            <div className="homepage-reservation">
                ...
                <div className='max-md:flex max-md:justify-center max-md:items-center'>
                    <button className='reservation-button max-md:mt-12 max-md:mb-12 text-white border px-6 py-4 hover:scale-125 transition duration-200 ' >Reserve Table</button>
                </div>
            </div>
        </div>
    )
